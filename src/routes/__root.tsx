...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Eesh Unisex Salon — Premium Hair & Beauty in Anchepalya, Bengaluru" },
      ...
      { name: "twitter:description", content: "Premium unisex salon near Chikkabidarakallu Metro. Haircuts, hair spa, keratin, bridal makeup, facials & more. Rated 4.8★ on Google." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1a34b23c-26cc-47e2-b554-c413745efae3/id-preview-be187c33--2a94ee98-1bf8-4028-84db-fa605310850f.lovable.app-1784834423701.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/1a34b23c-26cc-47e2-b554-c413745efae3/id-preview-be187c33--2a94ee98-1bf8-4028-84db-fa605310850f.lovable.app-1784834423701.png" },
    ],
    links: [
